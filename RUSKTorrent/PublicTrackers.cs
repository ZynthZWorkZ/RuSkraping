...
/// <summary>
/// Public tracker list for fallback when torrent trackers fail.
/// Source: https://github.com/ngosang/trackerslist
/// </summary>
public static class PublicTrackers
{
    /// <summary>
    /// Gets a list of reliable public trackers.
    /// These are used as fallback when the torrent's original trackers fail.
    /// </summary>
    public static List<string> GetPublicTrackers()
    {
        return new List<string>
        {
            // UDP trackers (generally faster)
